...
$done1 = "ساخت <b>".$buildnum."</b> سرباز به پایان رسید.";
    mysql_query("UPDATE ".TB_PREFIX."users set gold = ".($session->gold-50)." where `username`='".$session->username."'") or die(mysql_error());
...
?>
			...
			<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلای  <?php echo نراوو ?>">10</td>
			<td class="act">
<?php
    $MyGold = mysql_query("SELECT * FROM ".TB_PREFIX."users WHERE `username`='".$session->username."'") or die(mysql_error());
    $golds = mysql_fetch_array($MyGold);
...
?>               
			...
			<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلا <?php echo Travo ?>">5 </td>
			<td class="act">
<?php
...
?>
			...
			<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلای  <?php echo NAME_FA?>">5</td>
			<td class="act">
<?php
...
بصورت فوری تمام کن (در مورد اقامتگاه و قصر کار نمی کند).</td>
			...
			<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلای <?php echo Travo ?>">2</td>
			<td class="act">
<?php
if (mysql_num_rows($MyGold)) {
	if($golds['gold'] > 1) {
 ...
 ?>
		...
		<tr>
			...
			<td class="dur">فوری</td>
			<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلای <?php echo Travo?>">50</td>
			<td class="act">
	<?php
				if (mysql_num_rows($MyGold)) {
					if($golds['gold'] > 49) {
...
?>
		...
		<tr>
			...
			<td class="dur">فوری</td>
			<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلای  <?php echo NAME_FA?>">3</td>
			<td class="act link">
            <?php
        ...
        <tr>
				<td class="desc">مبادلۀ سکۀ طلای  <?php echo Travo?> و سکۀ نقرۀ  <?php echo Travo ?></td>
				<td class="dur">فوری</td>
				<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلای <?php echo Travo?>"></td>
				<td class="act arrow" style="text-align: right"><a class="arrow" href="plus.php?id=6">مبادله</a></td>
			</tr>
 <tr>
        </tbody>
</table>
<h4 class="spacer">کلوپ طلایی  <?php echo تراوو?></h4>
<table class="plusFunctions" cellpadding="1" cellspacing="1">
		<thead>
			<tr>
				<td>توضیح</td>
				<td>مدت زمان</td>
				<td>سکۀ طلای  <?php echo Travo?></td>
				<td>عمل</td>
			</tr>
		</thead>
		<tbody>
...
جز امکانات کلوپ طلایی نمی باشد.
				...
				<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلای  <?php echo Travo?>">100</td>
				<td class="act">
<?php
if($session->gold >= 100){
	if($golds['goldclub'] == 0) {
